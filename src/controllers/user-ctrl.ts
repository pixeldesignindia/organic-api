...
export default class UserController extends BaseController {
    ...
    public initializeRoutes() {
        this.router.post(constants.API.V1 + constants.API.APP.USER + '/followers', (req, res) => { this.getFollowers(req, res, this) });
        this.router.post(constants.API.V1 + constants.API.APP.USER + '/following', (req, res) => { this.getFollowing(req, res, this) });
        this.router.post(constants.API.V1 + constants.API.APP.USER + '/update-image', (req, res) => { this.updateImage(req, res, this) });
        this.router.post(constants.API.V1 + constants.API.APP.USER + '/add-following', (req, res) => { this.addFollowing(req, res, this) });
        this.router.post(constants.API.V1 + constants.API.APP.USER + '/remove-following', (req, res) => { this.removeFollowing(req, res, this) });
    }

    private updateImage(req: Request, res: Response, that: any) {
        that.service.updateImage(req.body, req.headers).then((result: any) => {
    ...
    private addFollowing(req: Request, res: Response, that: any) {
        that.service.addFollowing(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private removeFollowing(req: Request, res: Response, that: any) {
        that.service.removeFollowing(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private getFollowers(req: Request, res: Response, that: any) {
        that.service.getFollowers(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private getFollowing(req: Request, res: Response, that: any) {
        that.service.getFollowing(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
