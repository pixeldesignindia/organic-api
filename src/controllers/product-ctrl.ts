...
export default class ProductController extends BaseController {
    ...
    public initializeRoutes() {
        this.router.get(constants.API.V1 + constants.API.APP.PRODUCT + '/detail/:id', (req, res) => { this.find(req, res, this) });
        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/recent', (req, res) => { this.getRecentProducts(req, res, this) });

        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/add-images', (req, res) => { this.addImages(req, res, this) });
        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/remove-image', (req, res) => { this.removeImage(req, res, this) });
        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/set-default-image', (req, res) => { this.setDefaultImage(req, res, this) });

        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/has-liked', (req, res) => { this.hasLiked(req, res, this) });
        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/has-bookmarked', (req, res) => { this.hasBookmarked(req, res, this) });

        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/add-like', (req, res) => { this.addLike(req, res, this) });
        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/remove-like', (req, res) => { this.removeLike(req, res, this) });
        this.router.get(constants.API.V1 + constants.API.APP.PRODUCT + '/likes/:id/:pageNumber/:pageSize', (req, res) => { this.getLikes(req, res, this) });

        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/add-comment', (req, res) => { this.addComment(req, res, this) });
        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/update-comment', (req, res) => { this.updateComment(req, res, this) });
        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/remove-comment', (req, res) => { this.removeComment(req, res, this) });
        this.router.get(constants.API.V1 + constants.API.APP.PRODUCT + '/comments/:id/:pageNumber/:pageSize', (req, res) => { this.getComments(req, res, this) });

        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/add-bookmark', (req, res) => { this.addBookmark(req, res, this) });
        this.router.post(constants.API.V1 + constants.API.APP.PRODUCT + '/remove-bookmark', (req, res) => { this.removeBookmark(req, res, this) });
        this.router.get(constants.API.V1 + constants.API.APP.PRODUCT + '/bookmarks/:id/:pageNumber/:pageSize', (req, res) => { this.getBookmarks(req, res, this) });
    }

    private getRecentProducts(req: Request, res: Response, that: any) {
        that.service.getRecentProducts(req.body, req.headers).then((result: any) => {
    ...
    private getLikes(req: Request, res: Response, that: any) {
        that.service.getLikes(req.params, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private getComments(req: Request, res: Response, that: any) {
        that.service.getComments(req.params, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private getBookmarks(req: Request, res: Response, that: any) {
        that.service.getBookmarks(req.params, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private setDefaultImage(req: Request, res: Response, that: any) {
        that.service.setDefaultImage(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private hasLiked(req: Request, res: Response, that: any) {
        that.service.hasLiked(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private hasBookmarked(req: Request, res: Response, that: any) {
        that.service.hasBookmarked(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private removeImage(req: Request, res: Response, that: any) {
        that.service.removeImage(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private addImages(req: Request, res: Response, that: any) {
        that.service.addImages(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private addLike(req: Request, res: Response, that: any) {
        that.service.addLike(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private removeLike(req: Request, res: Response, that: any) {
        that.service.removeLike(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private addComment(req: Request, res: Response, that: any) {
        that.service.addComment(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private updateComment(req: Request, res: Response, that: any) {
        that.service.updateComment(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private removeComment(req: Request, res: Response, that: any) {
        that.service.removeComment(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private addBookmark(req: Request, res: Response, that: any) {
        that.service.addBookmark(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
    ...
    private removeBookmark(req: Request, res: Response, that: any) {
        that.service.removeBookmark(req.body, req.headers).then((result: any) => {
            that.responseUtil.sendReadResponse(req, res, result, 200);
        }, (err: any) => {
